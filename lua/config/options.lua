-- Or for a more visible notification:
vim.notify("options.lua module loaded successfully", vim.log.levels.INFO)
...
-- ]]
vim.o.number = true
vim.o.relativenumber = true --enable absolute line numbers
